...
`r if(!knitr:::is_latex_output()) 'A dissertation submitted to the University of Bristol in ac- cordance with the requirements of the degree of Doctor of Philosophy in the Faculty of Health Sciences.'`

`r if(!knitr:::is_latex_output()) '## Abstract {-}'`

`r if(!knitr:::is_latex_output()) knitr::knit_child("00-abstract.Rmd", quiet=TRUE)`

`r if(!knitr:::is_latex_output()) '## Acknowledgements {-}'`

`r if(!knitr:::is_latex_output()) knitr::knit_child("00-acknowledgements.Rmd", quiet=TRUE)`
