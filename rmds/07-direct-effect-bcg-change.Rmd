...
read_formated("universal-nonukborn-results-summary") %>%
  make_summary_table(
    caption.short = "Comparison of models fitted to incidence rates for the non-UK born population that were eligible to the universal vaccination programme of those at school-age (14).", 
...
read_formated("targeted-ukborn-results-summary") %>%  
  make_summary_table(
    caption.short = "Comparison of models fitted to incidence rates for the UK born population that were elgible to the targeted vaccination programme of neonates.", 
