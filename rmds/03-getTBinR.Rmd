 ...
 * As of the 1st of July 2019, `getTBinR` has been released on CRAN for over a year. It has been downloaded over 9000 times, has no outstanding bug-related issues, and has received multiple updates greatly expanding the functionality available. The standalone dashboard hosted online (http://www.seabbs.co.uk/shiny/ExploreGlobalTB/) has had over 3000 unique users. 
