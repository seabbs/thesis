...
sum_prior_posterior %>% 
  ...
  select(-latex_param) %>% 
kable(
  caption.short = "Prior and posterior medains for fitted model parameters", 
  caption = "Prior and posterior medains for fitted model parameters. (95\\% CI): 95\\% credible interval estimated using the 2.5\\% quantile and the 97.5\\% quantile.",
