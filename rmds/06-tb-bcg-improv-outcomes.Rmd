...
demo_tab_bcg %>% 
  ...
  kable(caption = "Potential confounders for individuals in England notified with TB between 2009-2015,  stratified by BCG vaccination status.",
         booktabs = TRUE, escape = TRUE) %>% 
    column_spec(c(1), width = "3cm") %>% 
    add_indent(indents) %>% 
    kable_styling(font_size = 8) %>% 
