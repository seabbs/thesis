...
```{r 10-scenarios-deaths-fig, fig.scap = "Forecast TB mortality for each scenario evaluated from 2005 to 2040, stratified by age group.", fig.cap = "Forecast TB mortality for each scenario evaluated from 2005 to 2040, stratified by age group. Scenarios are differentiated by colour. The darker ribbon for each colour identifies the interquartile range, whilst the lighter ribbon indicates the 2.5% and 97.5% quantiles. The line represents the median."}
knitr::include_graphics(file.path(plots_path, "overview-scenarios-deaths-future-1.png"))
```
