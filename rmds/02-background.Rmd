...
plot_tb_burden_summary(conf = NULL, verbose = FALSE, viridis_end = 1) + theme(text = element_text(size = 12))
```
...
summarise_tb_burden(countries = "Russia", 
  ...
  select(Area = area, `Median Proportion of Rifampicin resistant cases with MDR* (2.5% to 97.5% quantiles)`) %>% 
  knitr::kable(
               caption = "Percentage (\\%) of rifampicin resistant TB cases that have multi-drug resistant TB in Russia and regional medians, with interquartile ranges.",
        booktabs = TRUE) %>% 
