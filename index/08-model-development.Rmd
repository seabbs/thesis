...
```{r summary-scenarios, results = "asis"}
scenarios <- tibble(
  ...
  add_row(
    ...
    Scenario = c("*Linear increase from 1960 to 1999 based on notifications in 2000*",
                 "Increasing from 1960 to 1999 based on notifications in 2000 using a log link function.")
  )

pander(scenarios, caption = "(\\#tab:summary-scenarios) Summary of planned scenario analyses to be carried out in the next chapter as part of model fitting by comparision of the goodness of fit to the data. The baseline scenarios are indicated using italics.", split.cells = c(1, 20, 60), split.table = 100)
```
