...
% Everything below added by CII
  ...
  \item
    SMC\^{}2 model fitting with 2000 initial parameter particles. Particle rejuvernation was set to trigger when the effective sample size decreased below 25\%, with 5 MCMC steps used each time.
  \item
