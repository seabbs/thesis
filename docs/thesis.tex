...
% Everything below added by CII
  ...
  \caption[Prior and posterior distributions for fitted model parameters.]{Prior and posterior distributions for fitted model parameters. Parameter names in figure are in their coded form. They can be interpreted using the following:  $\beta_{\text{young adult}}$}\label{fig:09-fig-prior-params}
  \end{figure}
  \begin{longtable}{lll}
