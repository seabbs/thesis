...
% Everything below added by CII
  ...
  \end{figure}
  \begin{longtable}{lll}
  \caption[Prior and posterior medains for fitted model parameters]{\label{tab:09-prior-posterior}Prior and posterior medains for fitted model parameters. (95\% CI): 95\% credible interval estimated using the 2.5\% quantile and the 97.5\% quantile.}\\
  \toprule
  ...
  \textbackslash{}caption{[}Forecast TB incidence for each scenario evaluated from 2005 to 2040{]}\{Forecast TB incidence for each scenario evaluated from 2005 to 2040. Scenarios are differentiated by colour. The darker ribbon for each colour identifies the interquartile range, whilst the lighter ribbon indicates the 2.5\% and 97.5\% quantiles. The line represents the median.\}\label{fig:10-overall-scenarios-fig}
  \textbackslash{}end\{figure\}
  ...
  \textbackslash{}caption{[}Forecast TB mortality for each scenario evaluated from 2005 to 2040, stratified by age group.{]}\{Forecast TB mortality for each scenario evaluated from 2005 to 2040, stratified by age group. Scenarios are differentiated by colour. The darker ribbon for each colour identifies the interquartile range, whilst the lighter ribbon indicates the 2.5\% and 97.5\% quantiles. The line represents the median.\}\label{fig:10-scenarios-deaths-fig}
  \textbackslash{}end\{figure\}
  \begin{longtable}{rlll}
