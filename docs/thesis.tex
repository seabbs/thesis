...
% Everything below added by CII
  ...
  \item
    SMC-SMC model fitting with 1000 initial parameter particles. Particle rejuvernation was set to trigger when the effective sample size decreased below 25\%, with 10 MCMC steps used each time.
  \item
  ...
  After development of the model fitting pipeline but before results could be produced both the \texttt{optimise} (from \texttt{rbi}) and \texttt{adapt\_particle} (from \texttt{rbi.helpers}) began to error with a difficult to debug \texttt{LibBi} error message. This meant that steps 3-5 of the model fitting pipeline could not be used with the final model. As a work around the maximum permitted number of particles (256) was used for all model fitting (increasing the number of particles was also explored as detailed in the previous section).
  ...
  \end{itemize}
  \begin{verbatim}
  Warning in add_footnote(., label = "* 95% credible interval estimated using
  the 2.5% quantile and the 97.5% quantile.", : Notation is set to 'number'
  and other formats are not supported.
  \end{verbatim}
  \begin{longtable}{rrl}
  \caption[Observed versus predicted overall TB incidence for years that the model was fitted too.]{\label{tab:09-table-incidence-preds}Observed versus predicted overall TB incidence for years that the model was fitted too. The model underpredicted incidence for all years fitted too. The upper credible interval of the model predictions was substantially lower than the observed data. }\\
  \toprule
  Year & Observed Incidence & Predicted Incidence (95\% CI)*\\
  \midrule
  2000 & 1803 & 373 (134, 645)\\
  2001 & 1866 & 364 (132, 626)\\
  2002 & 1833 & 357 (131, 607)\\
  2003 & 1685 & 349 (133, 596)\\
  2004 & 1776 & 339 (134, 580)\\
  \bottomrule
  \end{longtable}
  \begin{figure}
  ...
  \midrule
  \$\textbackslash{}beta\_\{\textbackslash{}text\{young adult\}\}\$ & 4.88 (0.35, 9.74) & 5.72 (5.72, 5.72)\\
  \$c\_\{\textbackslash{}text\{eff\}\}\$ & 1.22 (0.09, 3.13) & 0.06 (0.06, 0.06)\\
  \$c\textasciicircum{}\{\textbackslash{}text\{hist\}\}\_\{\textbackslash{}text\{eff\}\}\$ & 10.50 (1.38, 19.36) & 1.28 (1.28, 1.28)\\
  \$c\textasciicircum{}\{\textbackslash{}text\{hist\}\}\_\{\textbackslash{}text\{half\}\}\$ & 5.95 (0.53, 15.80) & 4.34 (4.34, 4.34)\\
  \$M\$ & 1.22 (0.08, 3.07) & 0.71 (0.71, 0.71)\\
  \addlinespace
  \$M\_\{\textbackslash{}text\{young adult\}\}\$ & 5.19 (0.23, 9.76) & 9.98 (9.98, 9.98)\\
  \$E\_\{\textbackslash{}text\{syst\}\}\$ & 0.90 (0.82, 0.98) & 0.90 (0.90, 0.90)\\
  \$E\_\{\textbackslash{}text\{noise\}\}\$ & 0.01 (0.00, 0.02) & 0.02 (0.02, 0.02)\\
  \$\textbackslash{}iota\_\{\textbackslash{}text\{scale\}\}\$ & 100.27 (3.34, 196.54) & 192.90 (192.90, 192.90)\\
  \$\textbackslash{}epsilon\textasciicircum{}\{\textbackslash{}text\{older-adult\}\}\_L\$ & 2.01 (1.18, 2.98) & 2.19 (2.19, 2.19)\\
  \bottomrule
  \end{longtable}
  ...
  \{\centering \includegraphics[width=0.8\linewidth]{chapters/model-fitting/plots/incidence-sensitivity-1}
  
  \}
  
  \textbackslash{}caption{[}Partial rank correlation coefficients for each parameter fitted too.{]}\{Partial rank correlation coefficients for each parameter fitted too. Parameter names in figure are in their coded form. They can be interpreted using the following: beta\_young\_adult - \(\beta_{\text{young adult}}\), c\_eff - \(c_{\text{eff}}\), c\_hist - \(c^{\text{hist}}_{\text{eff}}\), c\_hist\_half - \(c^{\text{hist}}_{\text{half}}\), M - \(M\), M\_young\_adult - \(M_{\text{young adult}}\), meas\_error - \(E_{\text{syst}}\), meas\_std - \(E_{\text{noise}}\), non\_uk\_scaling - \(\iota_{\text{scale}}\), older\_adult\_activation\_scaling - \(\epsilon^{\text{older-adult}}_L\)\}\label{fig:09-fig-sens}
  \textbackslash{}end\{figure\}
  \#\# Discussion
  ...
  {\centering \includegraphics[width=0.8\linewidth]{chapters/model-fitting/plots/overview-scenarios-future-1} 
  ...
  \caption{\label{tab:10-table-future-incidence}}\\
  \toprule
  Year & School-age BCG (95\% CI)* & Neonatal BCG (95\% CI)* & No BCG (95\% CI)*\\
  \midrule
  2005 & 331 (132, 555) & 322 (125, 553) & 332 (132, 551)\\
  2010 & 281 (115, 472) & 295 (123, 494) & 312 (141, 506)\\
  2015 & 231 (93, 386) & 242 (95, 408) & 256 (108, 416)\\
  2020 & 193 (74, 326) & 200 (79, 343) & 216 (90, 352)\\
  2025 & 160 (62, 270) & 168 (65, 289) & 180 (74, 290)\\
  \addlinespace
  2030 & 134 (50, 229) & 139 (52, 240) & 149 (60, 242)\\
  2035 & 112 (42, 191) & 117 (43, 202) & 125 (47, 209)\\
  2040 & 95 (35, 159) & 98 (35, 169) & 105 (40, 172)\\
  \bottomrule
  \end{longtable}
  \begin{itemize}
  \tightlist
  ...
  {\centering \includegraphics[width=0.8\linewidth]{chapters/model-fitting/plots/overview-scenarios-deaths-future-1} 
  ...
  \end{verbatim}
  \begin{longtable}{rlll}
  \caption{\label{tab:10-table-deaths-preds}}\\
  \toprule
  Year & School-age BCG (95\% CI)* & Neonatal BCG (95\% CI)* & No BCG (95\% CI)*\\
  \midrule
  2005 & 21 (6, 38) & 22 (6, 39) & 21 (7, 40)\\
  2010 & 18 (5, 32) & 19 (6, 34) & 19 (7, 35)\\
  2015 & 15 (4, 27) & 16 (5, 29) & 16 (6, 29)\\
  2020 & 12 (4, 22) & 13 (4, 24) & 13 (5, 24)\\
  2025 & 10 (3, 19) & 11 (3, 20) & 11 (4, 20)\\
  \addlinespace
  2030 & 8 (2, 15) & 9 (3, 16) & 9 (3, 17)\\
  2035 & 7 (2, 13) & 7 (2, 13) & 7 (3, 14)\\
  2040 & 6 (2, 11) & 6 (2, 11) & 6 (2, 12)\\
  \bottomrule
  \end{longtable}
  \begin{itemize}
  \tightlist
