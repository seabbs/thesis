...
% Everything below added by CII
  ...
  \textbackslash{}caption{[}Prior and posterior distributions for fitted model parameters.{]}\{Prior and posterior distributions for fitted model parameters. Parameter names in figure are in their coded form. They can be interpreted using the following: beta\_young\_adult\}\label{fig:09-fig-prior-params}
  ...
  \midrule
  $\beta_{\text{young adult}}$ & 4.88 (0.35, 9.74) & 5.72 (5.72, 5.72)\\
  $c_{\text{eff}}$ & 1.22 (0.09, 3.13) & 0.06 (0.06, 0.06)\\
  $c^{\text{hist}}_{\text{eff}}$ & 10.50 (1.38, 19.36) & 1.28 (1.28, 1.28)\\
  $c^{\text{hist}}_{\text{half}}$ & 5.95 (0.53, 15.80) & 4.34 (4.34, 4.34)\\
  $M$ & 1.22 (0.08, 3.07) & 0.71 (0.71, 0.71)\\
  \addlinespace
  $M_{\text{young adult}}$ & 5.19 (0.23, 9.76) & 9.98 (9.98, 9.98)\\
  $E_{\text{syst}}$ & 0.90 (0.82, 0.98) & 0.90 (0.90, 0.90)\\
  $E_{\text{noise}}$ & 0.01 (0.00, 0.02) & 0.02 (0.02, 0.02)\\
  $\iota_{\text{scale}}$ & 100.27 (3.34, 196.54) & 192.90 (192.90, 192.90)\\
  $\epsilon^{\text{older-adult}}_L$ & 2.01 (1.18, 2.98) & 2.19 (2.19, 2.19)\\
  \bottomrule
  \end{longtable}
