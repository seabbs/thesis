...
% Everything below added by CII
  ...
  This warning is displayed once per session.
  \end{verbatim}
  \begin{center}\includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/tb-case-detection-1} \end{center}
  \begin{center}\includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/tb-case-detection-2} \end{center}
  \begin{center}\includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/tb-case-detection-3} \end{center}
  \begin{verbatim}
  Warning: Removed 184 rows containing non-finite values (stat_ydensity).
  \end{verbatim}
  \begin{verbatim}
  Warning: Removed 184 rows containing missing values (geom_point).
  \end{verbatim}
  \begin{center}\includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/tb-case-detection-4} \end{center}
  \begin{center}\includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/tb-case-detection-5} \end{center}
