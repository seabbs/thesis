...
% Everything below added by CII
  ...
  \end{figure}
  \begin{longtable}{lll}
  \caption[Observed versus predicted overall TB incidence for years that the model was fitted too.]{\label{tab:09-prior-posterior}Observerd versus predicted overall TB incidence for years that the model was fitted too. The model underpredicted incidence for all years fitted too. The upper credible interval of the model predictions was substantially lower than the observed data. (95\% CI): 95\% credible interval estimated using the 2.5\% quantile and the 97.5\% quantile.}\\
  \toprule
  ...
  {\centering \includegraphics[width=200px]{chapters/model-fitting/plots/incidence-sensitivity-1} 
  ...
  \caption{\label{tab:10-table-future-incidence}(95\% CI): 95\% credible interval estimated using the 2.5\% quantile and the 97.5\% quantile.}\\
  \toprule
  ...
  \end{figure}
  \begin{longtable}{rlll}
  \caption{\label{tab:10-table-deaths-preds}(95\% CI): 95\% credible interval estimated using the 2.5\% quantile and the 97.5\% quantile.}\\
  \toprule
  Year & School-age BCG (95\% CI) & Neonatal BCG (95\% CI) & No BCG (95\% CI)\\
  \midrule
